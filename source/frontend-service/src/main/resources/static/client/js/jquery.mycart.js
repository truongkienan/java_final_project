...
(function ($) {
  ...
  var loadMyCartEvent = function (userOptions) {
    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        ...
        $cartTable.append(
          ...
          '<td>' + this.name + '</td>' +
          '<td title="Unit Price">' + formatVND(this.price) + '</td>' +
          '<td title="Quantity"><input type="number" min="1" style="width: 70px;" class="' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
          '<td title="Total" class="' + classProductTotal + '">' + formatVND(total) + '</td>' +
    ...
    var showGrandTotal = function () {
      $("#" + idGrandTotal).text(formatVND(ProductManager.getTotalPrice()));
    }
    var showDiscountPrice = function () {
      $("#" + idDiscountPrice).text(formatVND(options.getDiscountPrice(ProductManager.getAllProducts(), ProductManager.getTotalPrice(), ProductManager.getTotalQuantity())));
    }
    ...
    */
    ...
    $(document).on("input", "." + classProductQuantity, function () {
      ...
      $(this).parent("td").next("." + classProductTotal).text(formatVND(price * quantity));
